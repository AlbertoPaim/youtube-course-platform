...
interface PlayerGroupClassProps {
    title: string;
    position: number;
    classes: Omit<PlayerClassProps, 'onCheck' | 'onPlay'>[]
    open: boolean;
    onToggle: () => void;
}

export const PlayerGroupClass = ({ title, position, classes, open, onToggle }: PlayerGroupClassProps) => {
    return (

        <div className="flex flex-col">
            <button className="flex p-4 gap-4 bg-paper items-center" onClick={onToggle}>
